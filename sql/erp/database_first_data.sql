...
INSERT INTO crud_service (name, menu, template, save_and_exit, filter_fields, order_by, is_on_line, title, fields) VALUES ('stockAction', 'requestProduct', NULL, true, 'name', NULL, NULL, 'Ação sobre o Estoque', '{"id":{"type":"i","primaryKey":true,"hiden":true},"name":{"type":"s","required":true}}');
