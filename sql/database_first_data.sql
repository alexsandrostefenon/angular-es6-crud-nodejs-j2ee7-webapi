INSERT INTO crud_service (name, menu, template, save_and_exit, filter_fields, order_by, is_on_line, title, fields) VALUES ('crudService', 'admin', NULL, NULL, 'name', NULL, NULL, NULL, '{"name":{"type":"s","primaryKey":true,"required":true},"title":{"type":"s"},"template":{"type":"s"},"menu":{"type":"s"},"saveAndExit":{"type":"b"},"filterFields":{"type":"s"},"orderBy":{"type":"s"},"isOnLine":{"type":"b"},"fields":{"type":"s","readOnly":true}}');
...
INSERT INTO crud_service (name, menu, template, save_and_exit, filter_fields, order_by, is_on_line, title, fields) VALUES ('category', 'admin', NULL, false, 'name', NULL, NULL, 'Controle de Categorias de Produtos e Serviços', '{"id":{"type":"i","primaryKey":true,"hiden":true},"name":{"type":"s","required":true}}');
