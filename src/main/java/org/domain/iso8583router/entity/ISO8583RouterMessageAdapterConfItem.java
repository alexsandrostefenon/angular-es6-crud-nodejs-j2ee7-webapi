...
@Entity
@Table(name = "iso8583router_message_adapter_item", schema = "public")
public class ISO8583RouterMessageAdapterConfItem implements java.io.Serializable {
	...
	public ISO8583RouterMessageAdapterConfItem(Integer id, String fieldName, String tag, Integer minLength, Integer maxLength,
	...
	public ISO8583RouterMessageAdapterConfItem() {
	}
