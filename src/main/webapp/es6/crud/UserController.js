...
//      debugger;
    	...
    	//
    	// Menu do usuário
//    	$routeProvider.when("/app/:name/:action", {templateUrl: "templates/crud/crud.html", controller: "CrudController", controllerAs: "vm"});
    	const fieldsMenu = {
...
*/
    	const fieldsRoute = {
    			...
    			"templateUrl":{"defaultValue":"templates/crud/crud.html"},
...
//        this.crudItemService = new CrudItem(this.serverConnection, "requestService", "request", this.primaryKey, 'Serviços', null, list => onServicesChanged(list), (field, id) => onServiceSelected(field, id));
    }
